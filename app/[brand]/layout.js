export async function generateMetadata({ params: { brand } }) {
	...
	const title = `--${formattedBrand} купить в Минске в кредит и лизинг в автосалоне "AutoCar"`;
	const metaDescription = `ᐈ ⭐ ${formattedBrand} купить в Минске в кредит и лизинг ✫ Автосалон: Кредит и лизинг на б/у авто ➤➤➤ До 10 лет. ☎️ (33) 355-88-55 ⚡ Большой выбор автомобилей ⚡ Помощь в выборе авто ⭐ Офомление в день подачи ⭐ Без взоса ✓ Без справок и поручителей.`;
