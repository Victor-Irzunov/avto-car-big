...
export const metadata = {
	...
	description: "ᐈ ⭐ Комиссионная продажа автомобиля в Минске ⚡ Продать авто выгодной и быстро ⚡ Продадим ваш автомобиль 🚘 быстро ➤➤➤ Быстрая оценка. ☎️ (33) 355-88-55 ⚡ Любое состояние авто ⭐ подготовим к продаже, сделаем мойку кузова, чернение резины, отбеливание дисков 🔥 Звоните прямо сейчас!",
	keywords: "",
	alternates: {
