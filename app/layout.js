...
export const metadata = {
  title: "Автосалон в Минске | Лизинг и Кредит на авто б/у | Покупка, продажа, обмен",
  description: "ᐈ ⭐ Автосалон: Купить или продать автомобиль быстро ⚡ Кредит и лизинг на б/у авто ⚡ Большой выбор автомобилей ⚡ Помощь в выборе авто ⭐ Офомление в день подачи ⭐ Без взоса ✓ Без справок и поручителей ➤➤➤ До 10 лет ☎️ (33) 355-88-55 ⭐ Нас советуют друзьям 🔥 Звоните прямо сейчас!",
  keywords: "кредит на авто, лизинг авто, автосалон, кредит на покупку авто, автокредит, машина в лизинг, купить авто в лизинг, кредит на покупку авто бу, лизинг без первого взноса, кредит на авто бу, автолизинг, обмен, продажа, покупка, Минск",
  alternates: {
