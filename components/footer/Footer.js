      ...
      <div className='container mx-auto'>
        ...
        <aside className='mt-8'>
          ...
          <div className='text-[10px] sd:mt-0 xz:mt-4'>
            <p className=''>Банк: ЗАО «Альфа-Банк»,</p>
            <p className=''>г. Минск, ул. Сурганова, 43-47</p>
            <p className=''>БИК банка: ALFABY2X</p>
            <p className=''>р/с: BY40 ALFA 3012 2G50 3400 1027 0000</p>
          </div>
        </aside>
      </div>
